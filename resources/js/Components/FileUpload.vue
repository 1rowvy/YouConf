    ...
    <div v-if="allFiles.length" class="mt-4 space-y-3">
      ...
      >
        ...
        <button
          ...
          class="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full text-gray-300 hover:text-red-500 hover:bg-red-50 transition-all duration-200 sm:opacity-0 sm:group-hover:opacity-100"
        >
