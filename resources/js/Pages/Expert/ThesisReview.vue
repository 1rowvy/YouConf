        ...
        <div class="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
            ...
            <div class="flex flex-wrap gap-4 text-sm text-gray-500 mb-6">
                <span>
                    ...
                    <span v-if="thesis.user.patronymic">{{
                        thesis.user.patronymic
                    }}</span>
                </span>
                <span>
                ...
                <span>
                    ...
                    {{ thesis.revision_count }} /
                    {{ thesis.section.revision_limit }}
                </span>
            </div>
            ...
            <div v-if="mediaFiles && mediaFiles.length" class="mb-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    >
                        <div
                            v-if="isImage(file)"
                            class="aspect-square rounded-lg overflow-hidden mb-2"
                        >
                            <img
                        ...
                        <div
                            v-else
                            class="aspect-square rounded-lg bg-gray-100 flex items-center justify-center mb-2"
                        >
                            <span
                                class="text-2xl"
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1 text-right">
                            {{ form.review_comment.length }} / 5000
                        </p>
                    </div>

                    <div
                        v-if="errorMessage"
                        class="px-4 py-3 bg-red-50 border border-red-100 rounded-xl text-sm text-red-600"
                    >
                        {{ errorMessage }}
                    </div>
...
function submitReview() {
    ...
    form.post(`/theses/${props.thesis.id}/status`, {
        ...
        onError: (errors) => {
            submitting.value = false;
            errorMessage.value =
                errors.message || "Произошла ошибка при сохранении.";
        },
        onFinish: () => {
            submitting.value = false;
        },
